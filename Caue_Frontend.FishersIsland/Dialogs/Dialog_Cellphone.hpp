...
class contactsmenu
{
	...
	class controls {
		...
		class listbox: RscListbox
		{
			...
			h = 0.132 * safezoneH;
			sizeEx = "0.015 * safezoneH";
			onLbSelChanged = "[] call Caue_Phone_SelContact";
		};
...
class smsmessagemenu
{
	...
	class controls {
		...
		*/
		...
		{
			idc = 1000;
			text = "Configurações"; //--- ToDo: Localize;
			x = 0.417499 * safezoneW + safezoneX;
			y = 0.291 * safezoneH + safezoneY;
			w = 0.165 * safezoneW;
			h = 0.044 * safezoneH;
		...
		{
			idc = 1001;
			text = "O número do seu celular é: 6969695"; //--- ToDo: Localize;
			x = 0.417499 * safezoneW + safezoneX;
			y = 0.335 * safezoneH + safezoneY;
		...
		{
			idc = 1003;
			text = "Mostrar Twitter:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
			y = 0.423 * safezoneH + safezoneY;
		...
		{
			idc = 1004;
			text = "Nivel Grama:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
			y = 0.445 * safezoneH + safezoneY;
			w = 0.0567187 * safezoneW;
			h = 0.022 * safezoneH;
		...
		{
			idc = 1005;
			text = "Mostrar HUD:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
			y = 0.401 * safezoneH + safezoneY;
			w = 0.118594 * safezoneW;
			h = 0.022 * safezoneH;
		...
		{
			idc = 1006;
			text = "Ocultar notificações:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
		...
		{
			idc = 1007;
			text = "Texto twitter:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
			y = 0.489 * safezoneH + safezoneY;
			w = 0.0670312 * safezoneW;
			h = 0.022 * safezoneH;
		...
		{
			idc = 1008;
			text = "Icone twitter:"; //--- ToDo: Localize;
			x = 0.422656 * safezoneW + safezoneX;
...
class Dialog_Phone_Incoming
{
	...
	class controls
	{
		...
		{
			idc = 1002;
			text = "Chamada Recebida..."; //--- ToDo: Localize;
			x = 0.438125 * safezoneW + safezoneX;
			y = 0.346 * safezoneH + safezoneY;
			w = 0.12375 * safezoneW;
			h = 0.033 * safezoneH;
		...
		{
			idc = 1613;
			text = "Atender"; //--- ToDo: Localize;
			x = 0.432969 * safezoneW + safezoneX;
			y = 0.676 * safezoneH + safezoneY;
			w = 0.139219 * safezoneW;
			h = 0.055 * safezoneH;
			action = "[] call Caue_Phone_AnswerCall;";
			sizeEx = "0.015 * safezoneH";
		};
	};

...
class Dialog_BagWeed
{
	...
	class controls {
		...
		{
			idc = 1000;
			text = "Digite um número entre 0 e 100 gramas e clique em ensacar a maconha!"; //--- ToDo: Localize;
		...
		{
			idc = 1001;
			text = "Quantia (em gramas):"; //--- ToDo: Localize;
		...
		{
			idc = 1600;
			text = "Ensacar maconha!"; //--- ToDo: Localize;
